...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL16GEN-00010-fragment.py --python_filename HIG-RunIISummer20UL16GEN-00010_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:HIG-RunIISummer20UL16GEN-00010.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 10000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL16GEN-00010-fragment.py nevts:10000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    # fileName = cms.untracked.string('file:HIG-RunIISummer19UL16GEN-00010.root'),
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGEN-03487.root'), #just to keep the chain psets unchanged
