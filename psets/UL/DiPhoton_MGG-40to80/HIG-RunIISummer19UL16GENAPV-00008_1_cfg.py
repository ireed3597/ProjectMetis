...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL16GENAPV-00008-fragment.py --python_filename HIG-RunIISummer20UL16GENAPV-00008_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:HIG-RunIISummer20UL16GENAPV-00008.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step GEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n 10000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL16GENAPV-00008-fragment.py nevts:10000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    # fileName = cms.untracked.string('file:HIG-RunIISummer19UL16GENAPV-00008.root'),
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16wmLHEGENAPV-03182.root'), # just to keep the pset chain unchanged
