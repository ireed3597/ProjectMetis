...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/ceph/cms/store/user/azecchin/gridpacks/CentralProductions/Tprime/TprimeTprime_ttHH_M1200_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
