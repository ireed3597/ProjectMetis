...
# with command line options: --python_filename HIG-RunIISummer20UL16HLT-01181_1_cfg.py --eventcontent RAWSIM --outputCommand keep *_mix_*_*,keep *_genPUProtons_*_* --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --inputCommands keep *,drop *_*_BMTF_*,drop *PixelFEDChannel*_*_*_* --fileout file:HIG-RunIISummer20UL16HLT-01181.root --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:25ns15e33_v4 --geometry DB:Extended --filein file:HIG-RunIISummer20UL16DIGIPremix-01176.root --era Run2_2016 --no_exec --mc -n 10000 --nThreads 1
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:HIG-RunIISummer20UL16DIGIPremix-01176.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL16HLT-01181.root'),
