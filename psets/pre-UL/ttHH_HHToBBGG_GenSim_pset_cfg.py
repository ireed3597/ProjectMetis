...
# with command line options: Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-03470-fragment.py --python_filename HIG-RunIIFall17wmLHEGS-03470_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:HIG-RunIIFall17wmLHEGS-03470.root --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(72) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2017 --no_exec --mc -n 393
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-03470-fragment.py nevts:393'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('25:m0 = 125.0', 
            ...
            'ResonanceDecayFilter:daughters = 5,5,22,22' # NOTE: why isn't this 5,-5,22,22?
        ),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    nEvents = cms.untracked.uint32(393),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(72)
