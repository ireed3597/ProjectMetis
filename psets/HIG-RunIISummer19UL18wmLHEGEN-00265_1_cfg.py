...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(18746)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer19UL18wmLHEGEN-00265-fragment.py nevts:18746'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer19UL18wmLHEGEN-00265.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer19UL18wmLHEGEN-00265_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'ResonanceDecayFilter:daughters = 22,22,5,5'
        ),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    nEvents = cms.untracked.uint32(18746),
